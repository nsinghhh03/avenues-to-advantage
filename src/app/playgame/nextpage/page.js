  ...
  return (
    <div className={styles.page} style={{background: '#e9e6fa'}}>
      ...
      <main className={styles.main}>
        ...
        <button className={styles.continueButton} style={{ background: '#ffd166', color: '#222', border: '2px solid #222', fontWeight: 600, fontSize: '1.1rem', margin: '190px auto 0 auto', display: 'block'}} onClick={() => router.push('/playgame/anotherpage')}>
          Continue
        </button>
      </main>
      {showInstructions && (
